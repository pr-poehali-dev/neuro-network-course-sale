          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                duration: "4 недели", 
                topics: ["Создаем концепцию, moodboard и реалистичные фактурные коллажи", "3D схемы любых чертежей для проекта", "Создание визуализаций по промту", "Меняем цвет, расположение или объект в интерьере на другой за 2 минуты"],
