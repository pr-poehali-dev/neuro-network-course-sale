            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl lg:text-2xl text-foreground/80 leading-relaxed" style={{fontFamily: 'Source Sans Pro'}}>
                  ...
                  Изучите передовые ИИ-технологии для создания уникальных пространств.
                </p>
              </div>
            ...
            {[
              {
                ...
                duration: "3 недели",
                topics: ["Введение в нейросети", "Midjourney для интерьеров", "ChatGPT в работе дизайнера", "Stable Diffusion"],
                color: "from-primary/20 to-secondary/20"
              },
              {
                icon: "Eye",
                title: "Модуль 2: Визуализация и рендер",
                duration: "4 недели", 
                topics: ["ИИ-рендеринг", "Автоматизация визуализации", "Стилизация интерьеров", "Презентация проектов"],
                color: "from-secondary/20 to-primary/20"
              },
              {
                icon: "Rocket",
                title: "Модуль 3: Практика и портфолио",
                duration: "3 недели",
                topics: ["Реальные кейсы", "Работа с клиентами", "Монетизация ИИ", "Создание портфолио"],
            ...
            {[
              {
                ...
                price: "49,900",
                period: "руб.",
                features: ["Доступ к курсу", "Базовая поддержка", "Сертификат", "6 месяцев доступа"],
                recommended: false
              },
              {
                ...
                price: "79,900",
                period: "руб.",
                features: ["Все из Базового", "Персональный ментор", "Разбор портфолио", "Год доступа", "Закрытое комьюнити"],
                recommended: true
              },
              {
                name: "Эксперт",
